...
if [ -d "$WDIR/data/$subject" ] ; then
    ...
    for dir_path in $dir_list ; do
        ...
        bet $derivatives/$dir_path/fmap/${dwi_noext}_hifi_nodif $derivatives/$dir_path/dwi/${dwi_noext}_corrected_brain.nii.gz -R -m -f 0.2
